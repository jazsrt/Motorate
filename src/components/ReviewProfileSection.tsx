          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="font-bold text-red-900 dark:text-red-300">
                Notice: Unusual Review Pattern
              </div>
              <div className="text-sm text-red-800 dark:text-red-400 mt-1">
                This user shows a pattern of mostly negative reviews ({Math.round(negativePercent)}%).
                Consider their review history before trusting ratings.
              </div>
            </div>
          </div>
        </div>
