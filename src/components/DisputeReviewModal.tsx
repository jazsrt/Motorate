            ...
            <div className="space-y-5">
              {reviewComment && (
                <div className="bg-surfacehighlight rounded-xl p-3 border-l-4 border-orange-500/50">
                  <p className="text-xs text-secondary uppercase tracking-wider font-bold mb-1">Review Being Disputed</p>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-3">
                <p className="text-xs text-orange-300 flex items-start gap-2">
                  ...
                  <span>Filing false disputes may result in account action. Only dispute reviews that genuinely violate our community guidelines.</span>
                </p>
              </div>
